...
const Error404 = () => {
	...
	return (
		<>
			<h1 className="pds-typography-center">Ope. This is not the page you were looking for...</h1>
			<Row className="pds-util-margin-top-20" justifyContent="center">
				<Col lg={6}>
					<Card>
						...
						<Image className={styles["gif-404"]} layout="responsive" src={gif404}alt="Not the droid you are looking for" priority />
					</Card>
				</Col>
			</Row>
		</>
